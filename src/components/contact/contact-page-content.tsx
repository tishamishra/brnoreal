...
export function ContactPageContent({ locale, searchParams }: ContactPageContentProps) {
  ...
  return (
    <div className="bg-site-canvas py-16">
      <div className="container space-y-12">
            ...
            {searchParams.listing && (
              <div className="mt-4 rounded-2xl border border-soft bg-[color:var(--brand-50)] p-4">
                <p className="text-sm font-semibold text-neutral-900">
                  Requesting concierge scheduling for: <span className="text-[color:var(--brand-600)]">{decodeURIComponent(String(searchParams.listing))}</span>
                </p>
              </div>
            )}
          </div>
        ...
        <ContactForm 
          listingTitle={searchParams.listing ? decodeURIComponent(String(searchParams.listing)) : undefined}
          listingId={searchParams.listingId ? decodeURIComponent(String(searchParams.listingId)) : undefined}
          location={searchParams.location ? decodeURIComponent(String(searchParams.location)) : undefined}
          propertyType={searchParams.propertyType ? decodeURIComponent(String(searchParams.propertyType)) : undefined}
        />
