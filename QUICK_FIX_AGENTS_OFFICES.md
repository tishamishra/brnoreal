# Quick Fix: Agents & Offices Error
...
## Cause
The `agents`, `offices`, or `contact_submissions` tables don't exist in your Supabase database yet.
...
2. Go to `/admin/agents` - should work now!
3. Go to `/admin/offices` - should work now!
4. Go to `/admin/contacts` - should work now!

## After Setup

Once tables are created, you can:
- Add agents via `/admin/agents/new`
- Add offices via `/admin/offices/new`
- View contact form submissions in `/admin/contacts`
