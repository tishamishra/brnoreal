# Seed Agents & Offices Data

## Quick SQL to Insert Data

Copy and paste this SQL into Supabase SQL Editor to populate your agents and offices tables:
...
1. **Make sure tables exist first** - Run the migration from `ADMIN_SETUP_GUIDE.md` if you haven't already

2. **Go to Supabase SQL Editor**: https://app.supabase.com/project/lanktmrtqaisnbbdiaet/sql/new

3. **Copy and paste the SQL above**

4. **Click "Run"**

5. **You should see**: "Success. 3 rows inserted" (or similar)

6. **Refresh admin panel** - Go to `/admin/agents` and `/admin/offices` to see the data!
